    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <a class="btn btn-primary float-end" href="/products?action=create">Add New product</a>
...
<%--            <th scope="col">Price</th>--%>
<%--            <th scope="col">Description</th>--%>
<%--&lt;%&ndash;            <th scope="col">Product type</th>&ndash;%&gt;--%>
<%--            <th colspan="2"></th>--%>
<%--        </tr>--%>
<%--        </thead>--%>
<%--        <tbody>--%>
...
<%--                <td>${product.price}</td>--%>
<%--                <td>${product.description}</td>--%>
<%--&lt;%&ndash;                <td>${category.name}</td>&ndash;%&gt;--%>
<%--                <td>--%>
<%--                    <a class="btn btn-info" href="/products?action=edit&id=${product.id}">--%>
<%--                        <i class="fas fa-edit"></i>--%>
<%--                    </a>--%>
