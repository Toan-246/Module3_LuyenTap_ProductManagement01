...
<div class="container">
    ...
    <a class="btn btn-primary float-end" href="/products">Back to List All products</a>
    <form action="/products?action=delete&id=${product.id}" method="post">
        <div class="mb-3">
            <label for="userid" class="form-label">ID</label>
            <input type="text" class="form-control" id="userid" name="id" disabled value="${product.id}">
        </div>
        <div class="mb-3">
